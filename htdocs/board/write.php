	...
	<article class="boardArticle">
		...
		<div id="boardWrite">
			<form action="./write_update.php" method="post">
				...
				?>
				<table id="boardWrite">
					<caption class="readHide">자유게시판 글쓰기</caption><br><br>
					<tbody>
						<?php
						echo '<input type="hidden" name="bID" value="'.$prove.'">';
						?>
						<tr>
				...
				<div class="btnSet">
					...
					<a href=# onclick="window.open('./upload.php','name','resizable=no width=450 height=130');return false">첨부파일</a>
