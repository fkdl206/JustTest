<?php
	...
	$bTitle = htmlentities($_POST['bTitle']);//htmlentities는 <,>,&,"를 변화하는 함수,이를 변환함으로써 <는 &lt로 변환되는데 이 문자를 브라우저가 발견하면 <문자를 HTML의 시작으로 생각하지않는다.

	$bContent = htmlentities($_POST['bContent']);
